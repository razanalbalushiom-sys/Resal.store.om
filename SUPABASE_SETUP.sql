...
CREATE TABLE IF NOT EXISTS orders (
  ...
  "vatRate" DECIMAL(5, 2) DEFAULT 5,
  "vatAmount" DECIMAL(10, 3) DEFAULT 0,
  total DECIMAL(10, 3) NOT NULL DEFAULT 0,
  total_price DECIMAL(10, 3),
  status VARCHAR(50) DEFAULT 'new',
  items JSONB DEFAULT '[]'::jsonb,
  payment VARCHAR(50) DEFAULT 'thawani',
  proof TEXT,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS payment VARCHAR(50) DEFAULT 'thawani';
